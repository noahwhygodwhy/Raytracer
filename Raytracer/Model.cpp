...
Mesh Model::processMesh(aiMesh* mesh, const aiScene* scene, const mat4& nodeTx) {
    ...
    if (mesh->mMaterialIndex >= 0)
    {
        ...
        diffuse = loadMaterialTextures(material, aiTextureType_DIFFUSE, "texture_diffuse")[0]; //cause screw more than one texture
        specular = loadMaterialTextures(material, aiTextureType_SPECULAR, "texture_specular")[0];
